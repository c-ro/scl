...
1. Download theme'as zip file from your account at https://catchthemes.com/my-account/
2. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
3. Click Upload and Choose File, then select the theme's .zip file. Click Install Now.
4. Go to https://catchthemes.com/theme-instructions/divin-pro/ for a guide on how to customize this theme.
...
Divin includes support for Infinite Scroll in Jetpack, Essential Content Types, To Top, Catch Instagram Feed Gallery and Widget  and Catch Web Tools.
...
Divin Theme bundles the following third-party resources:
