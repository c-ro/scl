...
function divin_scripts() {
	...
	wp_enqueue_style( 'divin-ie', esc_url( get_template_directory_uri() ) . '/css/ie.css', array( 'divin-style' ), '20160816' );
	wp_style_add_data( 'divin-ie', 'conditional', 'lt IE 10' );

	// Load the Internet Explorer 8 specific stylesheet.
	wp_enqueue_style( 'divin-ie8', esc_url( get_template_directory_uri() ) . '/css/ie8.css', array( 'divin-style' ), '20160816' );
	wp_style_add_data( 'divin-ie8', 'conditional', 'lt IE 9' );

	// Load the Internet Explorer 7 specific stylesheet.
	wp_enqueue_style( 'divin-ie7', esc_url( get_template_directory_uri() ) . '/css/ie7.css', array( 'divin-style' ), '20160816' );
	wp_style_add_data( 'divin-ie7', 'conditional', 'lt IE 8' );

	// Load the html5 shiv.
	wp_enqueue_script( 'divin-html5', esc_url( get_template_directory_uri() ) . '/assets/js/html5.min.js', array(), '3.7.3' );
	wp_script_add_data( 'divin-html5', 'conditional', 'lt IE 9' );

	wp_enqueue_script( 'divin-skip-link-focus-fix', esc_url( get_template_directory_uri() ) . '/assets/js/skip-link-focus-fix.min.js', array(), '20160816', true );
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'divin-keyboard-image-navigation', esc_url( get_template_directory_uri() ) . '/assets/js/keyboard-image-navigation.min.js', array( 'jquery' ), '20160816' );
	}

 	wp_register_script( 'jquery-match-height', esc_url( get_template_directory_uri() ) . '/assets/js/jquery.matchHeight.min.js', array( 'jquery' ), '20151215', true );

	wp_enqueue_script( 'divin-script', esc_url( get_template_directory_uri() ) . '/assets/js/functions.min.js', array( 'jquery', 'jquery-match-height' ), '20160816', true );
	...
	if ( divin_check_section( $enable_slider ) || divin_check_section( $enable_testimonial ) ) {
		wp_enqueue_script( 'jquery-cycle2', esc_url( get_template_directory_uri() ) . '/assets/js/jquery.cycle/jquery.cycle2.min.js', array( 'jquery' ), '2.1.5', true );
		...
		if ( in_array( 'scrollVert', $transition_effects, true ) ) {
			wp_enqueue_script( 'jquery-cycle2-scrollVert', esc_url( get_template_directory_uri() ) . '/assets/js/jquery.cycle/jquery.cycle2.scrollVert.min.js', array( 'jquery-cycle2' ), '2.1.5', true );
		}

		// Flip transition plugin addition.
		if ( in_array( 'flipHorz', $transition_effects, true ) || in_array( 'flipVert', $transition_effects, true ) ) {
			wp_enqueue_script( 'jquery-cycle2-flip', esc_url( get_template_directory_uri() ) . '/assets/js/jquery.cycle/jquery.cycle2.flip.min.js', array( 'jquery-cycle2' ), '2.1.5', true );
		}
		...
		if ( in_array( 'tileSlide', $transition_effects, true ) || in_array( 'tileBlind', $transition_effects, true ) ) {
			wp_enqueue_script( 'jquery-cycle2-tile', esc_url( get_template_directory_uri() ) . '/assets/js/jquery.cycle/jquery.cycle2.tile.min.js', array( 'jquery-cycle2' ), '2.1.5', true );
		}

		// Shuffle transition plugin addition.
		if ( in_array( 'shuffle', $transition_effects, true ) ) {
			wp_enqueue_script( 'jquery-cycle2-shuffle', esc_url( get_template_directory_uri() ) . '/assets/js/jquery.cycle/jquery.cycle2.shuffle.min.js', array( 'jquery-cycle2' ), '2.1.5', true );
		}
	}

	// Enqueue fitvid if JetPack is not installed.
	if ( ! class_exists( 'Jetpack' ) ) {
		wp_enqueue_script( 'jquery-fitvids', esc_url( get_template_directory_uri() ) . '/assets/js/fitvids.min.js', array( 'jquery' ), '1.1', true );
	}
